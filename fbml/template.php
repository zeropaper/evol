 ...
 */
function evol_fbml_preprocess_page(&$vars, $hook) {
...
function evol_fbml_preprocess_node(&$vars) {
...
function evol_fbml_menu_local_task($link, $active = FALSE) {
...
function evol_fbml_menu_item_link($link) {
  global $_fb_canvas_state;
...
function evol_fbml_menu_local_tasks() {
  global $fb;
...
function evol_fbml_fieldset($element) {
  global $fb;
  if (($fb && $fb->in_fb_canvas()) ||
      fb_is_fbml_canvas()) {
